...
#define Str_SOC_Size 32
#define Str_SingleVoltage_Size 32
#define Str_Temperature_Size 32
void SDCard_Init(void);
void SDCard_Write_SingleVoltage(float voltage, uint8_t id);
void SDCard_Write_SOC(float soc);
void SDCard_Write_Current(float current);
void SDCard_Write_Temperature(float temperature, uint8_t id);
void SDCard_Write_Smoke(float smoke);
void SDCard_Write_CC(uint8_t cc);
